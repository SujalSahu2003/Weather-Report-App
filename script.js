            ...
            fetch(url)
                ...
                .then(data => {
                    document.getElementById('weather').innerHTML = `
                        ...
                        <button onclick="showMoreDetails()" style="margin-top:10px; padding:8px 15px; background:#007BFF; color:#fff; border:none; border-radius:5px; cursor:pointer;">📋 More Details</button>
                    `;
